...
def main():
    ...
    temp_env = make_env_fn(
        ...
        tuned_Kq=None,
        tuned_Dq=None,
        start_phase=0,  # tune for Phase 0 balance; set to None or 2 to tune default
    )()
    # Access base env underneath wrappers
    base_env = temp_env.env if hasattr(temp_env, "env") else temp_env
